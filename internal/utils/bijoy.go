...
func UnicodeToBijoy(input string) string {
	...
	knownMap := map[string]string{
		...
		"অর্ধদিবস":                               "AR©w`vem",
		"ছুটি":                                   "QywU",
		"ছুটির আবেদনপত্র":                        "QzwUi Av‡e`bcÎ",
		...
		"ছবি":                                   "Qwe",
		"এই কার্ডের মেয়াদ অব্যাহতি/অবসরপর্যন্ত":         "GB KvW©i gqv` Ae¨vnwZ/Aemich©šÍ",
		"এই কার্ডের মেয়াদ অব্যাহতি/অবসর পর্যন্ত":        "GB KvW©i gqv` Ae¨vnwZ/Aemich©šÍ",
		"ফ্যাক্টরির ঠিকানাঃ":                        "d¨v±ixi wVKvbvt",
		"ফ্যাক্টরির ঠিকানা":                         "d¨v±ixi wVKvbvt",
		"মাষ্টারবাড়ী, গাজীপুর সদর, গাজীপুর।":          "gv÷vevwo, MvRxcyi miic, MvRxcyi|",
		"মাষ্টারবাড়ী, গাজীপুর সদর, গাজীপুর":           "gv÷vevwo, MvRxcyi miic, MvRxcyi",
		"ফোনঃ-":                                 "‡dvbt-",
		"ফোনঃ":                                  "‡dvbt",
		"স্থায়ী ঠিকানাঃ":                          "¯’vqx wVKvbvt",
		"স্থায়ী ঠিকানা":                           "¯’vqx wVKvbvt",
		"ভাওয়াল মির্জাপুর,গাজীপুর সদর":               "fvIqvj wgR©vczi,MvRxcyi miic",
		"গাজীপুর।":                              "MvRxcyi|",
		"জরুরী যোগাযোগের ফোন নংঃ":                   "riyiix ‡hvMv‡hv‡Mi ‡dvo bst",
		"জরুরী যোগাযোগের ফোন নং":                    "riyiix ‡hvMv‡hv‡Mi ‡dvo bst",
		"জাতীয় পরিচয় পত্র নংঃ":                     "RvZxq cwiPq cÎ bst",
		"জাতীয় পরিচয় পত্র নং":                      "RvZxq cwiPq cÎ bst",
		"জাতীয় পরিচয়পত্র নং":                      "RvZxq cwiPqcÎ bst",
		"উক্ত পরিচয়পত্র হারাইয়া গেলে তাৎক্ষনিক ব্যবস্থাপনা কর্তৃপক্ষকে জানাইতে হইবে।": "D³ cwicPqcÎ nvivBqv ‡M‡j Zvr¶wbK e¨e¯’vcbv KZ©„c¶‡K RvbvB‡Z nB‡e|",
		"উক্ত পরিচয়পত্র হারাইয়া গেলে তাৎক্ষনিক ব্যবস্থাপনা কর্তৃপক্ষকে জানাইতে হইবে": "D³ cwicPqcÎ nvivBqv ‡M‡j Zvr¶wbK e¨e¯’vcbv KZ©„c¶‡K RvbvB‡Z nB‡e",
		"অফিস স্টাফ":                               "Awdm ¯÷vd",
		"প্রোডাকশন স্টাফ":                           "cÖevKkb ¯÷vd",
		"ওয়ার্কার":                                 "IqviKvi",
	}
